...
# What is the name of this app?
	define('APP_NAME', 'Trapper Keeper Rx');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'webmaster@p2.AlexanderPeletz.biz'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'apeletz512@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'alexan22_p4_AlexanderPeletz_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'a345df345dhfhg');
	define('TOKEN_SALT', 'a46hdgh36y68m3yb45b1345b');